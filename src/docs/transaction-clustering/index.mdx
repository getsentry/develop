...
// TODO: short summary of two steps
...
free-form user names cannot be dinstinguished from low-cardinality parts of a URL. For these cases, we run stateful, automatic transaction clustering.

![Architecture](./transaction-clustering-arch.png)

### Pattern-based Identifier Scrubbing

// TODO: link to regex instead
[code](https://github.com/getsentry/relay/blob/e543401086c556b769b67ccb96fbfaca411696c8/relay-general/src/store/transactions/processor.rs#L273-L277))
...
// TODO: deconstruct this section into other sections
