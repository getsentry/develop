...
If you want to back your feature [flag via options](#enabling-your-feature-in-production)
...
If you want to enable your feature for a subset of production users, you have
the choice of setting up your feature flag in Flagr, or using an option backed
rollout via Options automator.

[Options based features](#building-your-options-based-feature) allow a feature 
to be rolled out to a specific subset of
LA orgs, a percentage of EA orgs, and/or a percentage of all orgs. They don't 
allow the flexibility of targetting that Flagr allows. These can be used in high
scale situations.
