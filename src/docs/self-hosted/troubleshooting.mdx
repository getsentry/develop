...
If the script above still does not clear up enough disc space, you can try the following in postgres. This will lead to data loss in event details. _SENTRY_RETENTION_DAYS_ will need to be filled in manually.
```shell
