...
In some enterprise setups there is no direct Internet connection, you must use an HTTP proxy server. How do you install Sentry in this environment? Let us assume: 
