...
1. If you are coming from a version prior to `9.1.2`, you first need to upgrade to `9.1.2` and follow the next steps:
   ...
   ```
1. If you are coming from a version prior to `10.0.0`, you first need to upgrade to `10.0.0` and follow the next steps:
   ```
   <your.sentry.version> -> 10.0.0 -> 21.6.3 -> latest
   ```
