...
In case you need to allow custom sources, you can add extra CSP keywords. We support [django-csp](https://django-csp.readthedocs.io/en/latest/configuration.html) syntax. For example:
