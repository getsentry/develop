...
<Alert title="Note" level="info">
    Remember that you'd need to restart all Sentry services once you change your settings, preferably by re-running the <code>./install.sh</code> script. See the <Link to="/self-hosted/#configuration">configuration section</Link> for more information.
</Alert>
