...
```
 ...
 The way you can set this up is the same as [sentry.io](https://sentry.io) except, you need to use your own instance's [`url-prefix`](/config/#general) for the URLs mentioned in the documentation.
