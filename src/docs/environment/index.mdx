...
<Alert title="Python 2 notice" level="info">

We've recently switched our development environment to use Python 3 by default. Temporarily you will still be able
