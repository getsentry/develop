...
One of `bootstrap`'s steps [creates a starter `.env`](https://github.com/getsentry/sentry/blob/master/.env.example) which should 
contain recommended environment variables and what they do. `make direnv-help` also lists all of the latest supported environment 
variables.
