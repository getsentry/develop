...
| `subscription_plan`             | `string`     | [Example](#releasing-a-feature-to-organizations-with-specific-plans) |
...
You can enable a feature for only a specific team within an oranization
