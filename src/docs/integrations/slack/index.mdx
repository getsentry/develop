...
<Alert title="Note" level="info">
    It is preferred to re-run the <code>./install.sh</code> script, instead of restarting all Docker containers. See the <Link to="/self-hosted/#configuration">configuration section</Link> for more information.
</Alert>
