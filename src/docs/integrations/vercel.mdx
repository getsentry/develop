...
```yml
# Vercel #
vercel.client-id: blahblah_id
vercel.client-secret: blahblah_secret
vercel.integration-slug: my_integration_slug
```

Boom, done. Follow our [documentation on installing and configuring the Vercel integration](https://docs.sentry.io/workflow/integrations/global-integrations/#vercel) to use the integration. 