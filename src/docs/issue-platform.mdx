...
- `status_change`: <Link to="#status-change">StatusChangeMessage</Link>
...
- `project_id`: (int)
- `new_status`: (int) from the <Link url="https://github.com/getsentry/sentry/blob/2e5a39ff3dd4afbd33f2ff7d2ba161285107afe4/src/sentry/models/group.py#L148">GroupStatus</Link> enum. We currently support the following:
  - `UNRESOLVED`
  - `RESOLVED`
  - `IGNORED`
- `new_substatus`: (int | None) from <Link url="https://github.com/getsentry/sentry/blob/2e5a39ff3dd4afbd33f2ff7d2ba161285107afe4/src/sentry/types/group.py#L4">GroupSubStatus</Link> enum. We do not support the `NEW` substatus.
