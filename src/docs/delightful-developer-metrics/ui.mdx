...
You can alert on custom metrics. As always, you can create these alerts either from the Metrics page or by using the Alerts Wizard.

Metrics also play nicely with Dashboards. You can plot custom metrics in the Metrics tab and then later save them to a dashboard or go through the Dashboards directly.

![Metrics Dashboards and Alerts](/images/ddm-dashboards-alers.png)
