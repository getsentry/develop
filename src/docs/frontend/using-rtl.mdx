...
## Use the built-in contexts
The default Organization context can be overriden by passing the organization as a proptery to the 2nd argument of the `render()` function.

Example of overriding the default organization.features and organization.access:
```tsx
