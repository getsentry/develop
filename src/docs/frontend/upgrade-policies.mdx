...
1. To get CI to finish running you will need to do two things
   ...
   2. Label the PR with [`Trigger: getsentry tests`](https://github.com/getsentry/sentry/labels/Trigger%3A%20getsentry%20tests) to trigger the `getsentry / frontend` check.
