...
```json
GET /api/0/projects/?expand=organization
{
  "id": 5,
  "name": "foo",
  "organization": {
...
```json
GET /api/0/projects/?collapse=stats
{
  "id": 5,
  "name": "foo",
  ...
