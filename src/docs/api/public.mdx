...
for maintaining and owning the endpoint. You can see
the full list of teams [here](https://github.com/getsentry/sentry/blob/master/src/sentry/api/api_owners.py).
```python
