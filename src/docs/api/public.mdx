...
Specify an `operation_id` that will be shown as the title under the docs site sidebar.

Specify the function docstring that will be shown at the endpoint description on the docs site.
