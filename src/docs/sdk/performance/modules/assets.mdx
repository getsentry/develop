...
| `resource.render_blocking_status`      | string | whether the resource blocks UI rendering, values are 'non-blocking' or 'blocking' | recommended on all asset operations |
