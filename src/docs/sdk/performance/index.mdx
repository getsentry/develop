...
applications, `Sentry.span` shall return the root span of the transaction. If the
user disables global mode, `Sentry.span` shall return the latest unfinished span.
