---
title: "Trace Contexts (Deprecated)"
---

<Alert level="warning">

This page and Trace Contexts is deprecated and will be superseded by <Link to="/sdk/performance/dynamic-sampling-context">Dynamic Sampling Context</Link>.
Please use that page instead to look up information on tracing context propagation.
