...
<Alert title="WIP" level="info">
  Session based alerting is currently experimental.
</Alert>

Trigger an alert when a specified threshold of sessions experience an issue. 
Create a new [issue alert](https://docs.sentry.io/product/alerts/alert-types/#issue-alerts) and select the "If" condition 
