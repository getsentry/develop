...
<Alert title="Rate-Limit" level="info">

In order to allow different rate limits for individual envelope items, 
a [custom rate limit header was introduced](/rate-limit). SDKs using envelopes 
are expected to implement support this header.
