...
- Stack traces are limited to 250 frames from which 50 frames contain full information and the rest have the
variables and the pre and post context data removed. Data is removed from the middle of the stack preserving the top and
bottom of the stack frames.
