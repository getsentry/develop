...
<Alert title="Note" level="info">
  ...
  <ul>
    <li>If the stack trace is part of an error, exception or crash, add it to the <Link to="/sdk/event-payloads/exception/">Exception Interface</Link>.</li>
    <li>Otherwise, add it as a thread in the <Link to="/sdk/event-payloads/threads/">Threads Interface</Link>.</li>
  </ul>
</Alert>
