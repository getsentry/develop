...
: An optional value which refers to a thread in the <Link to="/sdk/event-payloads/threads/">Threads Interface</Link>.
...
: An optional stack trace object corresponding to the <Link to="/sdk/event-payloads/stacktrace/">Stack Trace Interface</Link>.
