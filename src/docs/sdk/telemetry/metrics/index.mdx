...
For that the same format as for the [`frame`](/sdk/protocol/event-payloads/stacktrace/) on the stacktrace
...
keys are the same format as the [`frame`](/sdk/protocol/event-payloads/stacktrace/) on the stacktrace.  Today
