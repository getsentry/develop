...
| `call_stack`          | StackFrame[] | The most relevant stack frames, that lead to the File I/O span. The stack frame should adhere to the [`StackFrame`](/sdk/protocol/event-payloads/stacktrace/#frame-attributes) interface. |                       |
...
| `frames.delay`    | number | The sum of all delayed frame durations in seconds during the lifetime of the span. For more information see <Link to="/sdk/telemetry/tracing/frames-delay/">frames delay</Link>.   |   `1.3246`   |
