...
Sentry uses three containers to hold trace information [`sentry-trace`](/sdk/telemetry/tracing/#header-sentry-trace), [`traceparent`](/sdk/telemetry/tracing/#header-traceparent) and [`baggage`](/sdk/telemetry/tracing/dynamic-sampling-context/#baggage-header).
