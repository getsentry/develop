...
to="/sdk/protocol/event-payloads/sdk/">`debug_meta` interface</Link>. It is required to
...
Attributes](/sdk/protocol/event-payloads/stacktrace/#frame-attributes)).
...
[Envelope](/sdk/protocol/envelopes/) as the associated transaction with the item type
[`profile`](/sdk/protocol/envelopes/#profile) and send it to Relay.
