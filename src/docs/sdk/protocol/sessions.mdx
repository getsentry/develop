...
For basic health tracking Sentry accepts <Link to="/sdk/protocol/envelopes/">envelopes</Link>
...
The <Link to="/sdk/fundamentals/unified-api/">Unified API</Link> that SDKs should
