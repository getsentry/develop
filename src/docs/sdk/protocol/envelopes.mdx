...
: *Object, recommended.* This can carry the same payload as the <Link to="/sdk/protocol/event-payloads/sdk/">`sdk` interface</Link>
...
categories used for [rate limiting](/sdk/endpoints/rate-limiting/#definitions) and
client reports.
...
See the <Link to="/sdk/protocol/sessions/">sessions</Link> documentation for the payload
details.
