...
- If the stack trace is part of an error, exception or crash, add it to the [Exception Interface](/sdk/protocol/event-payloads/exception/).
- Otherwise, add it as a thread in the [Threads Interface](/sdk/protocol/event-payloads/threads/).
...
known image is defined in the [Debug Meta Interface](/sdk/protocol/event-payloads/debugmeta/), then
