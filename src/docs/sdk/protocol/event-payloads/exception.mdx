...
An <Link to="/sdk/protocol/event-payloads/">event</Link> may contain one or more exceptions in an attribute named `exception`.
...
: An optional value which refers to a thread in the <Link to="/sdk/protocol/event-payloads/threads/">Threads Interface</Link>.
...
: An optional stack trace object corresponding to the <Link to="/sdk/protocol/event-payloads/stacktrace/">Stack Trace Interface</Link>.
...
contains the exception part of the <Link to="/sdk/protocol/event-payloads/">event payload</Link> and omits other
