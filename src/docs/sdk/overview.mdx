...
At its core an SDK is a set of utilities for capturing data about an exceptional state in an application. Given this data, it then builds a JSON (or [Protobuf](https://protobuf.dev/)) payload and sends it to the Sentry server.
