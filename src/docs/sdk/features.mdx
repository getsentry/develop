...
Attachments are files stored alongside an event or transaction. To send an attachment, add it as an [envelope item](/sdk/envelopes/#attachment)
to the corresponding event or transaction.
...
of the attachment via the filename. Use the implementations of [Java](https://github.com/getsentry/sentry-java/blob/main/sentry/src/main/java/io/sentry/Attachment.java),
