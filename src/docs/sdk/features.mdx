...
If the SDK supports [transactions]((/sdk/envelopes/#transaction)), the attachments should offer a flag `addToTransaction`, that specifies if the attachment is added to transactions or not.
