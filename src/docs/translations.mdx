...
To update untranslated strings to Transifex, open a terminal within the Sentry repo and run the following:
...
You make encounter some errors when running `make update-local-locales`.
